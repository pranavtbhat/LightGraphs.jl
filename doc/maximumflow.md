...
The generic function *maximum_flow* defaults to the Push-relabel algorithm. The algorithm to be used can be specified
through a keyword argument and the following types:

- EdmondsKarpAlgorithm
- DinicAlgorithm
- PushRelabelAlgorithm

A default capacity of 1 is assumed for each link if no capacity matrix is provided.
